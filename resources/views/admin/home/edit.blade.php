    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        <h1 class="text-center" style="margin-top: 20px;">Update Home</h1>
                        <form class="admin-form" action="{{ route('home.update', $home->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $home->picture) }}" alt="{{ $home->picture }}"
                                    width="200px">
                                <p>Current: {{ $home->picture }}</p>
                            </div>
