    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        <h1 class="text-center" style="margin-top: 20px;">Create Skill</h1>
                        <form class="admin-form" action="{{ route('skill.store') }}" method="POST"
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('skill.index') }}" class="btn btn-secondary">Back to list</a>
                            </div>
                        </form>
                    </div>
                </main>
